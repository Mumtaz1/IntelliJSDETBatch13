...
public class Task2Students {
    ...
    public static void main(String[] args) {
        ...
        //static methods by just writing the name of that variable, we don't need to create an object.
        ...
        task2Students3.name = "Arif009";
        task2Students3.id = "JB125";
        numberOfStudents = 3;
