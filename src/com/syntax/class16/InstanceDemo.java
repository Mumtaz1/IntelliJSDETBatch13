...
public class InstanceDemo {
    ...
    public static void main(String[] args) {
        ...
        id.printInstanceValue(); //method once simply prints the value pf str which is still instance
        id.changeInstanceValue(); //this method changes the instance variable which will be not Captain Marvel
